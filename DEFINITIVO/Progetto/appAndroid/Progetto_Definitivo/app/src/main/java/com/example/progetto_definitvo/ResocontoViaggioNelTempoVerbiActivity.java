...
public class ResocontoViaggioNelTempoVerbiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resoconto_viaggio_nel_tempo_verbi);
        ...
        immagine=findViewById(R.id.gifImageView);

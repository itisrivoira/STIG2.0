    ...
    <div class="row">
      ...
      <div class="col-5">
        <div class="divArticoliTit">
          <h3>Articoli Indeterminativi</h3>
          <img data-draggable="indeterminativi" draggable="false" src="./img/scatolaIndeterminativi.png">
        </div>
        </br>
        <div class="divArticoliTit">
          <h3>Articoli Determinativi</h3>
          <img data-draggable="determinativi" draggable="false" src="./img/scatolaDeterminativi.png">
        </div>
      </div>
      <div class="col-2"></div>
      <!-- div Articoli -->
  ...
  <!-- Footer -->
    ...
    <script>
      ...
      document.addEventListener('drop', function(e){
          if(e.target.getAttribute('data-draggable') == 'indeterminativi'){
              indUtente.push(e.dataTransfer.getData('text'));
              item.style.display="none";
              arrayItem.push(item);
              e.preventDefault();
              cont++;
          }
          if(e.target.getAttribute('data-draggable') == 'determinativi'){
              detUtente.push(e.dataTransfer.getData('text'));
              item.style.display="none";
              arrayItem.push(item);
              e.preventDefault();
              cont++;
      ...
      document.addEventListener('dragend', function(e){
        ...
        if(cont==9){
          ...
          var c=0;
          do{
            if(!indeterminativi.includes(indUtente[c])) vinto=false;
            c++;
          }while(vinto==true && c<2);
          c=0;
          do{
            if(!determinativi.includes(detUtente[c])) vinto=false;
            c++;
          }while(vinto==true && c<6);

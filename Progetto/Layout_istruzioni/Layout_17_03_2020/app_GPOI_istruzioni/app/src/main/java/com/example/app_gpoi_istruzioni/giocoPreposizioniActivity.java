...
public class giocoPreposizioniActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        btnIstruzioni.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mioIntent = new Intent(getApplicationContext(),PreposizioniIstruzioniActivity.class);

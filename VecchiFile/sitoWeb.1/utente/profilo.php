        ...
        <div class="col-8">
            ...
            <div class="row mb-5">
              <div class=" floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="mb-0 text-white" id="password" type="password" value=<?php echo $passw ?> readonly>
              </div>
            </div>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-lg-8">
                      ...
                      <div class="row mb-3">
                        <div class="floating-label-form-group controls mb-0 pb-2">
                          <label>Nome</label>
                          <input class="mb-0" id="nomeModifica" type="text" value="Gianluca" onclick="select_all(this)">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="floating-label-form-group controls mb-0 pb-2">
                          <label>Cognome</label>
                          <input class="mb-0" id="cognomeModifica" type="text" value="Rossi" onclick="select_all(this)">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="floating-label-form-group controls mb-0 pb-2" id="divEmail">
                          <label>Email</label>
                          <input class="mb-0" id="emailModifica" type="email" value="gianluca.rossi@libero.it" onclick="select_all(this)">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="floating-label-form-group controls mb-0 pb-2" id="divPsw">
                          <label>Password</label>
                          <input class="mb-0" id="passwordModifica" type="password" value="ciao" onclick="select_all(this)">
                        </div>
                      </div>
                      <div class="row mb-5">
                        <div class="floating-label-form-group controls mb-0 pb-2">
                          <p>Conferma Password</p>
                          <input class="mb-0" id="passwordConferma" type="password" value="ciao" onclick="select_all(this)">
                        </div>
                      </div>
